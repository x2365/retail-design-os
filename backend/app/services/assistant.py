"""Ассистент: tool-calling поверх существующих данных.
...
SYSTEM_PROMPT = (
    "Ты — встроенный ассистент системы учёта производства торгового "
    "оборудования (POSM) для ритейл-сети. Отвечай по-русски, кратко "
...
def disabled_message() -> dict:
    return {
        ...
        + settings.llm_model
        + "» и включите LLM_ENABLED, чтобы пользоваться ассистентом.",
    }
