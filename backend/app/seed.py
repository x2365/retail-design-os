...
TASKS = [
    {
        ...
        "currency": "RUB",
        "tt": (42, 38, 2, 2),
        "team": ["А.Козлова", "В.Петров", "О.Сидорова"],
        "urgent": True,
    },
    {
        "code": "RD-038",
        "brand": "Botanica",
        "name": "Корнер Herbal Collection",
        "stage": 8,
        "days_left": 22,
        "budget": 980000,
        "sample": 120000,
        ...
        "currency": "RUB",
        "tt": (87, 87, 0, 0),
        "team": ["А.Козлова", "М.Иванов"],
        "urgent": False,
    },
    {
        "code": "RD-044",
        "brand": "Velvet",
        "name": "Ёмкость Prestige Line",
        "stage": 3,
        "days_left": 61,
        "budget": 0,
        "sample": 0,
        ...
        "currency": "EUR",
        "tt": (0, 0, 0, 0),
        "team": ["А.Козлова", "В.Петров"],
        "urgent": False,
    },
    {
        "code": "RD-039",
        "brand": "Novalux",
        "name": "Дисплей Eye Collection",
        "stage": 10,
        "days_left": 3,
        "budget": 540000,
        "sample": 60000,
        ...
        "currency": "RUB",
        "tt": (63, 44, 8, 11),
        "team": ["А.Козлова", "О.Сидорова", "К.Белов"],
        "urgent": True,
    },
    {
        "code": "RD-042",
        "brand": "SkinLab",
        "name": "Полка-авторизация Peptide Rx",
        "stage": 4,
        "days_left": 45,
        "budget": 190000,
        "sample": 30000,
    ...
    },
    {
        ...
        "currency": "USD",
        "tt": (28, 0, 0, 0),
        "team": ["А.Козлова", "В.Петров", "О.Сидорова", "К.Белов"],
        "urgent": True,
    },
]
...
APPROVALS = [
    {
        "from_name": "Команда Lumière",
        "role": "Бренд",
        "code": "RD-041",
        "summary": "RD-041 — эскиз Serum Pro Display",
        "type": "Эскиз",
        "avatar": "ЛЮ",
        "color": "#5b6af0",
    },
    {
        "from_name": "И. Воронов",
        "role": "Директор отдела",
        "code": "RD-040",
        "summary": "RD-040 — КП подрядчика Gold Corner",
        "type": "КП",
        "avatar": "ИВ",
        "color": "#f59e0b",
    },
    {
        "from_name": "Ритейлер-команда",
        "role": "Ритейлер",
        "code": "RD-041",
        "summary": "RD-041 — размеры и материал",
        "type": "Эскиз",
        "avatar": "РТ",
        "color": "#06d6a0",
    },
    {
        ...
        "role": "Оплата",
        "code": "RD-039",
        "summary": "RD-039 — счёт финальной оплаты",
        "type": "Счёт",
        "avatar": "БУ",
        "color": "#8b5cf6",
    },
...
PAYMENTS = [
    {
        ...
        "prepaid": "137 500 ₽",
        "balance": "137 500 ₽",
        "status": "Ожидает финала",
    },
    {
        "code": "RD-040",
        "contractor": "Eurostand GmbH",
        "kp_offset": -36,
        "currency": "EUR",
        "kp_amount": "€ 12 400 (1 085 000 ₽)",
        "sample": "€ 1 800 (157 500 ₽)",
        "tirazh": "€ 10 600 (927 500 ₽)",
        "prepaid": "€ 5 300 (463 750 ₽)",
        "balance": "€ 5 300",
        "status": "Предоплата внесена",
    },
    {
        "code": "RD-039",
        "contractor": "Рекламник ООО",
        "kp_offset": -90,
        "currency": "RUB",
        "kp_amount": "540 000 ₽",
        "sample": "60 000 ₽",
...
EQUIPMENT = [
    {
        ...
        "tirazh": 275000,
        "produced": 3,
        "description": "Акрил + металл, подсветка LED",
    },
    {
        "brand": "Lumière",
        "name": "Витрина Lumière Premium",
        "kind": "display",
        "dimensions": "600×400×1500 мм",
        "budget": 850000,
        "sample": 110000,
        "tirazh": 740000,
        "produced": 1,
        "description": "Напольная витрина с зеркалом",
    },
    {
        "brand": "Novalux",
        "name": "Дисплей Eye Collection",
        "kind": "display",
        "dimensions": "300×200×400 мм",
        "budget": 540000,
        "sample": 60000,
        "tirazh": 480000,
        "produced": 2,
        "description": "Настольный дисплей, 12 SKU",
    },
    {
        "brand": "Clarity",
        "name": "Полка Clarity Shelf",
        "kind": "shelf",
        "dimensions": "800×250×120 мм",
        "budget": 180000,
        "sample": 25000,
        "tirazh": 155000,
        "produced": 4,
        "description": "Навесная полка, лого-фрезеровка",
    },
    {
        "brand": "Botanica",
        "name": "Корнер Herbal Collection",
        "kind": "corner",
        "dimensions": "1200×800×2000 мм",
        "budget": 980000,
        "sample": 120000,
        "tirazh": 860000,
        "produced": 1,
        "description": "Угловой корнер с растительным декором",
    },
    {
        "brand": "SkinLab",
        "name": "Полка-авторизация Peptide Rx",
        "kind": "shelf",
        "dimensions": "700×300×400 мм",
        "budget": 190000,
        "sample": 30000,
        "tirazh": 160000,
        "produced": 2,
        "description": "Полка с авторизацией бренда",
    },
    {
        "brand": "VitaGlow",
        "name": "Тестер-стенд VitaGlow",
        "kind": "stand",
        "dimensions": "350×350×300 мм",
        "budget": 140000,
        "sample": 20000,
        "tirazh": 120000,
        "produced": 5,
        "description": "Стенд для тестеров, 8 позиций",
    },
    {
        "brand": "Premiere",
        "name": "Корнер Gold Signature",
        "kind": "corner",
        "dimensions": "1500×900×2200 мм",
        "currency": "USD",
        "budget": 1200000,
        "sample": 180000,
        "tirazh": 1020000,
        "produced": 0,
        "description": "Премиальный корнер, латунь + стекло",
    },
    {
        "brand": "Velvet",
        "name": "Ёмкость Prestige Line",
        "kind": "container",
        "dimensions": "200×200×250 мм",
        "currency": "EUR",
        "budget": 95000,
        "sample": 12000,
        "tirazh": 83000,
        "produced": 1,
        "description": "Презентационная ёмкость, бархат",
    },
    {
        "brand": "Orbis",
        "name": "Дисплей Orbis Round",
        "kind": "display",
        "dimensions": "Ø500×1600 мм",
        "budget": 620000,
        "sample": 80000,
        "tirazh": 540000,
        "produced": 0,
        "description": "Круглый вращающийся дисплей",
    },
]
